...
/*
* local_majhub_unrestored_report 
*
*
*/
...
/*
* local_majhub_coursewares_report 
*
*
*/

class local_majhub_coursewares_report extends  local_majhub_base_report {
	
	
	protected $report="unrestored";
	protected $fields = array('id','fullname','filesize','fileid','backuprelease','backupversion','unrestorable','courseid','hubcourseid','sitecourseid','startdate','uploaddate');	
	protected $headingdata = null;
	protected $qcache=array();
	protected $ucache=array();
	...
	public function process_raw_data($formdata){
		...
		$this->headingdata = new stdClass();
		//get all the users in the db
		$unrestoredcourses = $DB->get_records('majhub_coursewares',array());
